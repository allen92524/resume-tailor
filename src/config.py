...
MAX_TOKENS_IMPROVE_ENRICHED = 4096
MAX_TOKENS_VALIDATE = 1
MAX_GAP_QUESTIONS = 10
MAX_CONVERSATIONAL_FOLLOWUPS = 3
MAX_TOKENS_FOLLOWUP = 512
MAX_TOKENS_BULLET_IMPROVE = 512
MAX_TOKENS_CONFLICT_CHECK = 2048
MAX_TOKENS_EXPERIENCE_MATCH = 1024
MAX_TOKENS_UNIFIED_ANALYSIS = 4096
MAX_TOKENS_MIGRATION = 2048
MAX_TOKENS_MERGE_ANSWERS = 1024
